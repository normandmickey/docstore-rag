...
from .views import chatbot_binding_new, chatbot_definition_detail, chatbot_definition_edit, chatbot_definition_new, chatbot_endpoint_new, chatbot_event_detail, chatbot_index, chatbot_integration_edit, chatbot_integration_new, chatbot_zoom_connect_callback, chatbot_zoom_connect_start
...
urlpatterns = [
    ...
    path('definitions/<int:definition_id>/edit/', chatbot_definition_edit, name='chatbot_definition_edit'),
