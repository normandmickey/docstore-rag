...
from .views import chatbot_binding_new, chatbot_definition_detail, chatbot_definition_new, chatbot_endpoint_new, chatbot_index, chatbot_integration_edit, chatbot_integration_new
