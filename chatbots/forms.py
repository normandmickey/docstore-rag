...
PLATFORM_DEFINITION_PRESETS = {
    ChatbotIntegration.PLATFORM_TELEGRAM: {
        ...
        'system_prompt': 'Answer using the current workspace documents. Keep replies short and easy to read on mobile. Prefer a direct answer first, then a short supporting detail if needed. If a tenant shipping manager is configured and the user asks about a package or tracking number, use that shipping manager result as the answer source.',
        'allowed_tools_json': {'web_search': False, 'shipping_manager': True},
    ...
    ChatbotIntegration.PLATFORM_DISCORD: {
        ...
        'system_prompt': 'Answer from the current workspace documents. In DMs, reply directly. In servers, assume mention-first behavior and keep responses channel-friendly. If a tenant shipping manager is configured and the user asks about a package or tracking number, use that shipping manager result as the answer source.',
        'allowed_tools_json': {'web_search': False, 'shipping_manager': True},
    ...
    ChatbotIntegration.PLATFORM_ZOOM_CHAT: {
        ...
        'system_prompt': 'Answer using the current workspace documents. Keep responses short, clear, and professional. Avoid heavy markdown and lead with the direct answer. If a tenant shipping manager is configured and the user asks about a package or tracking number, use that shipping manager result as the answer source.',
        'allowed_tools_json': {'web_search': False, 'shipping_manager': True},
