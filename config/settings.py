...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Docstore API',
    'DESCRIPTION': 'Docstore API for document ingest, URL ingest, search, chat, support, chatbots, and integrations.',
    'VERSION': '1.0.0',
...
SHIPPING_MANAGER_BASE_URL = os.getenv('SHIPPING_MANAGER_BASE_URL', '')
SHIPPING_MANAGER_API_KEY = os.getenv('SHIPPING_MANAGER_API_KEY', '')
